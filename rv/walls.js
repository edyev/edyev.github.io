...
raycaster.setFromCamera(new THREE.Vector2(robot.position.x,robotposition.z),camara);
...
var camara, escena, renderer,wall1,wall2,wall3,wall4,raycaster,robot,stepx,stepz;
setup();
loop();
