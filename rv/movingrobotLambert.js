function Pierna(){
  ...
  this.pierna = new THREE.Mesh( new THREE.CylinderGeometry(0.1,0.1,2),new THREE.MeshLambertMaterial(0x9900FF));
  this.pie = new THREE.Mesh( new THREE.TorusGeometry(0.3,0.05,16,100),new THREE.MeshLambertMaterial(0x9900FF));
...
function setup(){
  var material = new THREE.MeshLambertMaterial(0x009999);
   var points = [];
